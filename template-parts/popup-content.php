...
<div class="popup-content">
	<div class="speakers-detail">
		...
		<div class="speakers-session">
			...
			<ul>
				<?php foreach ( $mu_session as $post ) : ?>
				<li>
					<a href="<?php the_permalink(); ?>">
						<div class="session-title"><?php the_title(); ?></div>
						<div class="session-info">
							<div class="session-date"><?php echo get_the_title( get_field( 'mu_session_date' ) ); ?></div>
							<div class="session-time"><?php the_field( 'mu_session_start_time' ); ?>-<?php the_field( 'mu_session_end_time' ); ?></div>
						</div>
					</a>
				</li>
