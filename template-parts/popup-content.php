...
<div class="popup-content">
	<div class="speakers-detail">
		...
		<?php
			$shares_path = '/';
			if ( has_term( array( 'game-changer', 'readers', 'advisory-board-members' ), 'speaker_type' ) ) {
				// ゲームチェンジャーまたはリーダーまたはアドバイザリーボード
				$shares_path = '/award/';
			} else {
				$shares_path = '/speaker/';
			}
		...
		<div class="footer-shares">
			...
			<ul class="a2a_kit" data-a2a-url="<?php echo home_url( $shares_path ); ?>#<?php echo $post->post_name; ?>" data-a2a-title="<?php the_title(); ?> - <?php bloginfo( 'name' ); ?>">
				<li class="facebook">
